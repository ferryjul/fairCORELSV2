...
typedef std::vector<unsigned short> confusion_matrix_data;
...
struct prefix_hash {
    std::size_t operator()(const prefix_key& k) const {
        ...
        for(size_t i = 1; i <= (*k.key)+8; ++i) // Adds "+8" to also hash TPp, ...etc
...
class PermutationMap {
    public:
        ...
        virtual Node* insert (unsigned short new_rule,
                             ...
                             tracking_vector<unsigned short, DataStruct::Tree> parent_prefix, confusion_matrix_data* confusion_matrix) { return NULL; }
...
class PrefixPermutationMap : public PermutationMap {
	public:
        ...
        Node* insert (unsigned short new_rule, size_t nrules, bool prediction, 
            ...
            DataStruct::Tree> parent_prefix, confusion_matrix_data* confusion_matrix) override;
	private:
		PrefixMap* pmap;
};
	...
	public:
        ...
        Node* insert(unsigned short new_rule, size_t nrules, bool prediction, bool default_prediction, 
                ...
                int len_prefix, double c, double equivalent_minority, CacheTree* tree, VECTOR not_captured,
                 tracking_vector<unsigned short, DataStruct::Tree> parent_prefix, confusion_matrix_data* confusion_matrix) override;
	private:
		CapturedMap* pmap;
};
